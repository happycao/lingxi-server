...
**[25/06/25]**  
1、本次更新涉及对用户密码改造，mysql中存储密文，但接口传递的依旧是明文  
2、更新了Swagger版本，移除了dom4j，不再解析xml  
3、更新fastjson为fastjson2，移除druid，使用hikari连接池  
...
**[19/05/18]**  
1、引入Swagger，生成接口文档，[服务启动后访问](http://localhost:8090/lingxi/swagger-ui/index.html)  
